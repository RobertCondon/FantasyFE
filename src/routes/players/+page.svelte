<script>
    ...
    import { Select, Label, Table, TableBody, TableHead, TableHeadCell, Search } from 'flowbite-svelte';
...
<div style="margin-bottom: 2rem;display: flex;align-content: center;justify-content: space-between;" >
